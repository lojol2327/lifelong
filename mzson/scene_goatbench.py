...
from mzson.geom import get_cam_intr, IoU
from mzson.utils import rgba2rgb
from mzson.tsdf_planner import SnapShot
from mzson.hierarchy_clustering import SceneHierarchicalClustering

# Local application/library specific imports
from mzson.conceptgraph.utils.ious import mask_subtract_contained
from mzson.conceptgraph.utils.general_utils import (
    ObjectClasses,
    measure_time,
    filter_detections,
)
from mzson.conceptgraph.slam.slam_classes import MapObjectDict, DetectionDict, to_tensor
from mzson.conceptgraph.slam.utils import (
    filter_gobs,
    filter_objects,
    get_bounding_box,
    init_process_pcd,
...
from mzson.conceptgraph.slam.mapping import (
    compute_spatial_similarities,
    compute_visual_similarities,
    aggregate_similarities,
    match_detections_to_objects,
)
from mzson.conceptgraph.utils.model_utils import compute_vlm_features_batched
...
class Scene:
    ...
    def make_detection_list_from_pcd_and_gobs(
        ...
        for mask_idx in range(len(gobs["mask"])):
            ...
            if gobs["image_feats"] is not None and gobs["image_feats"].numel() > 0 and gobs["image_feats"].shape[0] > mask_idx:
                detected_object["vlm_ft"] = to_tensor(gobs["image_feats"][mask_idx])
